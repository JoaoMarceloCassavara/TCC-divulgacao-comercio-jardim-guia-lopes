        ...
        <section class="py-3">
            <div class="card_lista_pedidos">
                <div class="d-flex justify-content-between ">
                    ...
                    @php
                        $total = $pedido->produtos->pluck('preco')->sum();
                    @endphp
                    <!-- exibir o total do pedido aqui -->
                    <div class="ps-2">
                        <p class="fw-bold fs-5 m-1">Total do pedido: R${{ number_format($total, 2, ',', '.') }}</p>
                    </div>
                ...
                @foreach ($pedido->produtos as $produto)
                    <div class="card_lista_pedidos_produto mb-1 d-flex justify-content-around">
                                ...
                                <form method="POST" action="{{ route('salvarLocalizacaoUsuario', $pedido->id) }}">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="col-md-6 register-itens-empresario-align  py-2">
                                            <textarea id="endereco_entrega" placeholder="Endereço de entrega"
                                                class="form-control register-itens-empresario @error('endereco_entrega') is-invalid @enderror"
                                                name="endereco_entrega" value="{{ old('endereco_entrega') }}" required autocomplete="endereco_entrega" autofocus></textarea>
