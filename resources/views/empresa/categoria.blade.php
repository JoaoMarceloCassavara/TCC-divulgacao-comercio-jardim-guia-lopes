...
<header class="mb-5 ">
    ...
    <img src="{{ Voyager::image($categoria_empresa->imagem) }}" height="350" class="categoria-imagem-categoria rounded-bottom"
...
<div class=" header_nome_categoria p-3 w-25 rounded-3 position-absolute">
    <h3 class=" text-center text-white">{{$categoria_empresa->nome}}</h3>
</div>
<div class="pt-5 ps-4 header_nome_categoria_mostrar">
    <h4>Empresas: {{$categoria_empresa->nome}}</h4>
  </div>

</header>
<section class=" d-flex flex-wrap pt-1 pb-5">
