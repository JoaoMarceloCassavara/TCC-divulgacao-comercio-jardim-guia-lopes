        ...
        <div class="card-body">
            <form method="POST" action="{{ route('empresa.salvar') }}">
                ...
                {{-- <div class="row mb-3">
                    ...
                    <div class="col-md-6 col-sm-12 register-itens-empresario-align py-2">
                        <input id="telefone" type="tel" pattern="\([0-9]{2}\)\s?[0-9]{4,5}-[0-9]{4}" placeholder="Telefone (99)99999-9999" class="form-control register-itens-empresario @error('telefone') is-invalid @enderror" name="telefone" required autocomplete="telefone">
