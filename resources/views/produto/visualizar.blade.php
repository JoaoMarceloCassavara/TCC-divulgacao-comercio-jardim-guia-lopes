...
@section('conteudo')
    <header class="mb-5">
        <div class="text-center position-relative">
            <img src="{{ Voyager::image($empresa->imagem) }}" height="300" class=" w-100  rounded-bottom"
        ...
        <div class=" header_nome_categoria p-3 w-25 rounded-3 position-absolute">
            <h3 class=" text-center">{{ $empresa->nome }}</h3>
        </div>
        <div class="ps-5 header_nome_categoria_mostrar">
          <h2>{{$categoria_produto->nome}}</h2>
        </div>
    </header>
    <section class="d-flex flex-wrap pt-4 ps-5">
