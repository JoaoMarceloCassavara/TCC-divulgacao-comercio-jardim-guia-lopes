                            ...
                            <div class="d-flex flex-wrap justify-content-center">
                                ...
                                <a href="{{ route('empresa.categoria', ['id' => $categoria_empresas[$posicao]->id]) }}" class="marcacao_a_remov text-black mb-4 mx-3">
                                    <div class="card_categoria_produto rounded-3 p-3" style="width: 150px; height: 200px;">
                                      <img src="{{ Voyager::image($categoria_empresas[$posicao]->imagem) }}" width="150" class="rounded-3 img-fluid" alt="Imagem Da categoria Dos Produtos" onerror="this.onerror=null;this.src='{{ asset('assets/images/imagens-default/imagem-categoria.png') }}';">
                                ...
                                <a href="{{ route('empresa.categoria', ['id' => $categoria_empresas[$posicao+1]->id]) }}" class="marcacao_a_remov text-black mb-4 mx-3">
                                    <div class="card_categoria_produto rounded-3 p-3" style="width: 150px; height: 200px;">
                                      <img src="{{ Voyager::image($categoria_empresas[$posicao+1]->imagem) }}" width="150" class="rounded-3 img-fluid" alt="Imagem Da categoria Dos Produtos" onerror="this.onerror=null;this.src='{{ asset('assets/images/imagens-default/imagem-categoria.png') }}';">
                                      <div class="text-center pt-2 pb-4">
                                ...
                                <a href="{{ route('empresa.categoria', ['id' => $categoria_empresas[$posicao+2]->id]) }}" class="marcacao_a_remov text-black mb-4 mx-3">
                                    <div class="card_categoria_produto rounded-3 p-3" style="width: 150px; height: 200px;">
                                      <img src="{{ Voyager::image($categoria_empresas[$posicao+2]->imagem) }}" width="150" class="rounded-3 img-fluid" alt="Imagem Da categoria Dos Produtos" onerror="this.onerror=null;this.src='{{ asset('assets/images/imagens-default/imagem-categoria.png') }}';">
                                      <div class="text-center pt-2 pb-4">
                                ...
                                <a href="{{ route('empresa.categoria', ['id' => $categoria_empresas[$posicao+3]->id]) }}" class="marcacao_a_remov text-black mb-4 mx-3">
                                    <div class="card_categoria_produto rounded-3 p-3" style="width: 150px; height: 200px;">
                                      <img src="{{ Voyager::image($categoria_empresas[$posicao+3]->imagem) }}" width="150" class="rounded-3 img-fluid" alt="Imagem Da categoria Dos Produtos" onerror="this.onerror=null;this.src='{{ asset('assets/images/imagens-default/imagem-categoria.png') }}';">
                                      <div class="text-center pt-2 pb-4">
